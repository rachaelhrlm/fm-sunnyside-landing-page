...
export const Header: FunctionComponent = () => {
    return (
        <div className="w-full h-[30rem] pt-[9rem] bg-[#3EBFFF] bg-mobile-header bg-bottom bg-cover bg-no-repeat md:h-[40rem] lg:bg-contain lg:bg-desktop-header lg:h-[40rem] lg:pt-[10rem]">
